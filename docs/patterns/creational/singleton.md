...
public class Singleton {
    ...
    private Singleton() {}
    /**
    * 第二次检查就是防止获取锁和成功获取锁之间对象已经完成了实例化
     * @return instance
     */
    public static Singleton getInstance() {
        if (instance == null) {
...
springboot的bean默认是单例的[官方文档](https://docs.spring.io/spring-framework/reference/core/beans/factory-scopes.html#beans-factory-scopes-singleton)
