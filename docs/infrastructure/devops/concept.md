...
| 项目 | 类型 | 主要作用 | 常见用途 |
|------|------|----------|----------|
| [containerd](chatgpt://generic-entity?number=0) | 容器运行时 | 真正负责“运行容器” | 被 Docker / K8s 调用 |
| [Docker](chatgpt://generic-entity?number=1) | 容器平台 | 构建 + 运行容器 | 本地开发最常用 |
| [Podman](chatgpt://generic-entity?number=2) | 容器引擎 | 类似 Docker，但无 daemon | Linux 服务器 |
| [Kubernetes](chatgpt://generic-entity?number=3) | 编排系统 | 管理大量容器和机器 | 生产集群 |
